...
static void Gameloop_Logos(void)
{
	...
	if (File_Exists(String_GenerateFilename("AND"))) Sprites_LoadImage(String_GenerateFilename("AND"), SCREEN_1, g_palette_998A);
	else Sprites_LoadImage("AND.CPS", SCREEN_1, g_palette_998A);
